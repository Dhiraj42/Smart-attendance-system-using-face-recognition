...
class Help:
    def __init__(self,root):
        ...
        help_lb=Label(first_lb,text="Email: dhirajsonawane@gmail.com",font=("time new roman",15,"bold"),fg="white",bg="black")
        help_lb.place(x=600,y=125)

        help_lb2=Label(first_lb,text="Email: shrinidhinmaatte@gmail.com",font=("time new roman",15,"bold"),fg="white",bg="black")
        help_lb2.place(x=600,y=165)

        help_lb3=Label(first_lb,text="Email: shahshankni12@gmail.com",font=("time new roman",15,"bold"),fg="white",bg="black")
