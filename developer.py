...
class Developer:
    def __init__(self,root):
        ...
        main_frame.place(x=800,y=40,width=500,height=500)
        ...
        first_lb.place(x=250,y=0,width=200,height=200)

        # Developer Info
        dev_lb=Label(main_frame,text="Dhiraj Sonawane(B2241014)",font=("time new roman",15,"bold"),bg="white",fg="#142552")
        dev_lb.place(x=10,y=45)

        dev_lb=Label(main_frame,text="Shashank Nigam(B2241050)",font=("time new roman",15,"bold"),bg="white",fg="#142552")
        dev_lb.place(x=10,y=95)

        dev_lb=Label(main_frame,text="Shrinidhi Matte(B2241062)",font=("time new roman",15,"bold"),bg="white",fg="#142552")
